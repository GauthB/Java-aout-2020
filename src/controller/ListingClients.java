 ...
 *         information of all the customers of the database
 */
	...
	public ListingClients() {
		...
		try {
			...
			try {
				...
				int i = 1;
				while (clientTb.next()) {
					String infoClient = clientTb.getString("nom") + " | " + clientTb.getString("adresse") + " | "
							+ clientTb.getString("tva") + " | " + clientTb.getString("email") + " | "
							+ clientTb.getString("telephone");
